  ...
  def play(self, word_played):
    if not self.solved:
      if word_played in validWords:
        ...
        print("After first move:", len(self.valid_words))
        #self.valid_words = get_valid_moves(self.valid_words, word_played, self.correct_word)
...
class MCTS:
    def __init__(self, initial_board):
      ...
      print("start of MCTS:", len(get_valid_moves(self.board.valid_words, self.root.word, self.board.correct_word)))
      self.root.children = get_valid_moves(self.board.valid_words, self.root.word, self.board.correct_word)
    ...
    def evaluate(self, node : Node):
      ...
      for i in self.root.children:
        ...
        best_child.children = get_valid_moves(self.root.children, self.board.guesses[0], self.board.correct_word)
    ...
    def simulate(self, node):
        ...
        for child1 in node.children:
          for child2 in node.children:
            node.value += evaluate(child1.word.word.word, child2.word.word.word)
